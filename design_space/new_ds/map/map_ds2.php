...
// TODO Find (a) Things in the new one that don't have a corresponding old one -- look thought the old ones that we haven't mapped.
// TODO Find (b) Things in the new one that have multiple ones in the old one - they might need to be split up
// TODO Check the ones that are mapped and make sure they're okay.
...
// 	{
// 		$q2 = "SELECT * FROM `ds_map` WHERE old_id = $r[id]";
// 		$ret2 = $db->q($q2);
...
// 		$q2 = "SELECT * FROM `to_map` WHERE old_id = $r[id]";
// 		$ret2 = $db->q($q2);
// 		if(!$ret2){ echo "Fail: $q2<br />"; continue; }
// 		$c = mysqli_num_rows($ret2);
...
// echo "<div class='header' style='width:100%;padding:10px;'>
// 			<table style='width:100%;'><tr>
// 			<td style='width:30px;''><span id='num'>$num</span>&nbsp;Old:</td> <td id='old_name' style='width:120px;'></td>
// 			<td style='width:30px;'>New:</td> <td id='new_name' style='width:120px;'></td>
...
// 	$newNode = findInTree($oldRoot, $new[$i]->name);
// 	$temp = $newNode;
// 	$tree = "";
