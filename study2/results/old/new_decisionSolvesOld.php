...
$q = "SELECT * FROM `custom_new_decision` AS cd
...
?>
		...
		<a href="new_optionSolvesOldDecision.php" class="btn" style="margin:10px;">Next: New options solve old decisions</a>
	</body>
</html>